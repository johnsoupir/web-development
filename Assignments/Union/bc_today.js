...
//To string
const dateString = thisDate.toLocaleDateString();
...
//Run the function which returns the html for the given day
const eventHTML = getEvent(thisDay);

//Generate the today at the union
const unionToday = document.getElementById("unionToday");
unionToday.insertAdjacentHTML("beforeend", dateHTML + eventHTML);
